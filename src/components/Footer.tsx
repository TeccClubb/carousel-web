...
const Footer: FC = () => {
  ...
  return (
    ...
    //       <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mt-16 lg:mt-0 lg:col-span-2 xl:col-span-3">
    //         <FooterSlice
    //           title="Products"
    //           links={[
    //             {
    ...
    //     <div className="w-full max-w-7xl mx-auto py-6 flex justify-between">
